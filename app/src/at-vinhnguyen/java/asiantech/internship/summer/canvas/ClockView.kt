...
class ClockView : View {
    ...
    private fun drawCenter(canvas: Canvas) {
        paint?.apply {
            ...
            canvas.drawCircle(width / 2, height / 2, 12f, this)
        }
    }
    ...
    private fun drawCircle(canvas: Canvas) {
        paint?.apply {
            this.reset()
            this.color = ContextCompat.getColor(context, android.R.color.black)
            this.strokeWidth = 5f
            this.style = Paint.Style.STROKE
            this.isAntiAlias = true
            canvas.drawCircle(width / 2, height / 2, radius + padding - 10, this)
        }
