package asiantech.internship.summer.javacore.exercise15;

import android.util.Log;

import static asiantech.internship.summer.javacore.InputUtils.inputIntNumber;

public class ListElementsThatAppearExactlyTwice {

    private static final String TAG = ListElementsThatAppearExactlyTwice.class.getSimpleName();
