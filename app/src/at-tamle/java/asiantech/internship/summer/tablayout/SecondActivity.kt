...
class SecondActivity : AppCompatActivity(), ViewPager.OnPageChangeListener {
    ...
    private fun initView() {
        ...
        fragments.add(Tab3Fragment())
        fragments.add(Tab1Fragment())
        viewPager.adapter = ViewPagerAdapter(supportFragmentManager, fragments, listOf(getString(R.string.tablayout_empty), getString(R.string.tablayout_home), getString(R.string.tablayout_info), getString(R.string.tablayout_another), getString(R.string.tablayout_empty)))
