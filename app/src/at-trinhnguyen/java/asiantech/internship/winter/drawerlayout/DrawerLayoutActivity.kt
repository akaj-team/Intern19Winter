...
import kotlinx.android.synthetic.`at-trinhnguyen`.activity_drawer_layout.*
...
class DrawerLayoutActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        navItems.add(null)
        navItems.add(NavItem(R.drawable.ic_inbox, resources.getString(R.string.textview_inbox)))
        navItems.add(NavItem(R.drawable.ic_send, resources.getString(R.string.textview_send)))
        navItems.add(NavItem(R.drawable.ic_trash, resources.getString(R.string.textview_trash)))
        navItems.add(NavItem(R.drawable.ic_spam, resources.getString(R.string.textview_spam)))
        recyclerView.adapter = NavItemAdapter(navItems, this)
    }
